  ...
  function SelectMenuController($scope, $attrs, $element) {
    ...
    self.setMultiple = function(isMultiple) {
      ...
      if (self.isMultiple) {
        ...
        // watchCollection on the models because by default ngModel only watches the models's
    ...
    self.init = function(ngModel, binding) {
      ...
      // Allow users to provide `ng-models="foo" ng-models-options="{trackBy: 'foo.id'}"` so
